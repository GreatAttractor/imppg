...
void c_ScrollableDialog::InitControls(int borderSize)
{
    ...
    m_Contents->Bind(wxEVT_SCROLLWIN_BOTTOM, &c_ScrollableDialog::OnContentsScrolled, this);
    m_Contents->Bind(wxEVT_SCROLLWIN_LINEDOWN, &c_ScrollableDialog::OnContentsScrolled, this);
    m_Contents->Bind(wxEVT_SCROLLWIN_LINEUP, &c_ScrollableDialog::OnContentsScrolled, this);
    m_Contents->Bind(wxEVT_SCROLLWIN_PAGEDOWN, &c_ScrollableDialog::OnContentsScrolled, this);
    m_Contents->Bind(wxEVT_SCROLLWIN_PAGEUP, &c_ScrollableDialog::OnContentsScrolled, this);
    m_Contents->Bind(wxEVT_SCROLLWIN_THUMBRELEASE, &c_ScrollableDialog::OnContentsScrolled, this);
    m_Contents->Bind(wxEVT_SCROLLWIN_THUMBTRACK, &c_ScrollableDialog::OnContentsScrolled, this);
    m_Contents->Bind(wxEVT_SCROLLWIN_TOP, &c_ScrollableDialog::OnContentsScrolled, this);
