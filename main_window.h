...
class c_MainWindow: public wxFrame
{
    ...
    typedef struct
    {
        ...
        wxBitmap *m_ImgBmp; ///< Bitmap which wraps 'm_Img' for displaying on 'm_ImageView'
        ...
        {
            float zoomFactor;
            wxBitmap *bmpScaled; ///< Currently visible scaled fragment (or whole) of 'm_ImgBmp'
    ...
    ProcessingSettings_t *m_CurrentSettings;
